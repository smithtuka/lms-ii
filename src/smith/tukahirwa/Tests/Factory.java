...
public class Factory {
    ...
    static List<Person> personList2 = List.of(
            new Person("Smith Tukahirwa", addressList.get(0), "smithtuka@gmail.com", "339-7077670"),
            new Person("Alice Tukahirwa", addressList.get(1), "alicenan@gmail.com", "449-12314151"),
            new Person("Alison Tukahirwa", addressList.get(2), "alison@gmail.com", "555-123415167"),
            new Person("Daisy Tukahirwa", addressList.get(3), "daisy@gmail.com", "414-12316452"),
            new Person("Kenneth Tukahirwa", addressList.get(4), "kenneth@gmail.com", "441-41516765"),
            new Person("Brock Tukahirwa", addressList.get(5), "brock@gmail.com", "334-2345643"),
            new Person("Rob Tukahirwa", addressList.get(6), "rob@gmail.com", "421-2345626"),
            new Person("Katie Tukahirwa", addressList.get(7), "katie@gmail.com", "554-6776524"),
            new Person("James Tukahirwa", addressList.get(8), "james@gmail.com", "324-2345667"),
            new Person("Dan Tukahirwa", addressList.get(9), "dan@gmail.com", "339-2344334")
    );
    ...
    List<Librarian> librarianList2 = List.of(
            new Librarian("L2003", AccountStatus.ACTIVE, personList.get(1)),
            new Librarian("L3004", AccountStatus.ACTIVE, personList.get(2)),
            new Librarian("L3005", AccountStatus.ACTIVE, personList.get(3)),
            new Librarian("L3006", AccountStatus.ACTIVE, personList.get(4)),
            new Librarian("L3007", AccountStatus.ACTIVE, personList.get(5)),
            new Librarian("L3008", AccountStatus.ACTIVE, personList.get(6)),
            new Librarian("L3009", AccountStatus.ACTIVE, personList.get(7)),
            new Librarian("L3010", AccountStatus.ACTIVE, personList.get(8)),
            new Librarian("L3011", AccountStatus.ACTIVE, personList.get(9)),
            new Librarian("L2012", AccountStatus.ACTIVE, personList.get(10))
    ...
    static {
        ...
        authorList.add(new Author("Timothy Wangusa", null, "timothy@msn.net", "785-123412"));
        authorList.add(new Author("Polpot King", null, "polpot@msn.net", "785-312341"));
        authorList.add(new Author("Sherry Berry", null, "sherry@msn.net", "785-141516"));
        authorList.add(new Author("Apple Smith", null, "apple@msn.net", "785-123511"));
        authorList.add(new Author("Andy Achebe", null, "andy@msn.net", "785-123412"));
        authorList.add(new Author("Russell Achebe", null, "russell@msn.net", "785-565443"));
        authorList.add(new Author("Anthony Sky", null, "anthony@msn.net", "785-654234"));
        authorList.add(new Author("Randle James", null, "randle@msn.net", "785-467654"));
        authorList.add(new Author("Kate Achebe", null, "kate@msn.net", "785-555960"));
    }
    ...
    public static List<BookItem> bookItemList2 = List.of(
      new BookItem("B-0098-SN-98","The Lion & the Jew", "Literature", "MK Publishers Ltd",
              "ENGLISH", 500, authorList2.subList(1, 2), "LT-002-001BC",false,
              LocalDate.of(2020,03,01), LocalDate.of(2020,03,21),
              230, BookFormat.HARDCOVER, BookStatus.AVAILABLE,
              LocalDate.of(2019,12,01),
              LocalDate.of(2019,05,01), 5 ),
    ...
    public static List<Member> memberList2 = List.of(
            ...
            new Member("M-002", AccountStatus.ACTIVE, personList2.get(1), LocalDate.of(2020,04,11), bookItemList.subList(0,0)),
            new Member("M-003", AccountStatus.CANCELED, personList2.get(2), LocalDate.of(2020,03,12), bookItemList.subList(0,1)),
            new Member("M-004", AccountStatus.CANCELED, personList2.get(3), LocalDate.of(2020,03,20), bookItemList.subList(0,2)),
            new Member("M-005", AccountStatus.ACTIVE, personList2.get(4), LocalDate.of(2020,01,13), bookItemList.subList(0,3)),
            new Member("M-006", AccountStatus.ACTIVE, personList2.get(5), LocalDate.of(2020,01,11), bookItemList.subList(0,4)),
            new Member("M-007", AccountStatus.ACTIVE, personList2.get(6), LocalDate.of(2020,02,26), bookItemList.subList(0,5)),
            new Member("M-008", AccountStatus.ACTIVE, personList2.get(7), LocalDate.of(2020,03,25), bookItemList.subList(0,6)),
            new Member("M-009", AccountStatus.BLACKLISTED , personList2.get(8), LocalDate.of(2020,07,30), bookItemList.subList(0,7)),
            new Member("M-010", AccountStatus.CANCELED, personList2.get(9), LocalDate.of(2020,01,10), bookItemList.subList(0,8))
   ...
   //static List <List<Rack>> RackList; - - might need it as List of Arrays/lists
    ...
    static {
        ...
        RackList2.add(new Rack(100, "L-01-01", bookItemList.subList(0, 0)));
        RackList2.add(new Rack(200, "G-01-02", bookItemList.subList(1, 1)));
        RackList2.add(new Rack(300, "G-01-03", bookItemList.subList(1, 2)));
        RackList2.add(new Rack(400, "G-01-04", bookItemList.subList(1, 3)));
        RackList2.add(new Rack(500, "G-01-05", bookItemList.subList(1, 4)));
        RackList2.add(new Rack(600, "G-01-06", bookItemList.subList(1, 5)));
        RackList2.add(new Rack(700, "G-01-07", bookItemList.subList(1, 6)));
        RackList2.add(new Rack(800, "G-01-08", bookItemList.subList(1, 7)));
        RackList2.add(new Rack(900, "G-01-09", bookItemList.subList(1, 8)));
        RackList2.add(new Rack(110, "G-01-10", bookItemList.subList(1, 9)));
    }
